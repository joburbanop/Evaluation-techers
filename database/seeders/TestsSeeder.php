...
class TestsSeeder extends Seeder
{
    public function run()
    {
        ...
        // ===== PREGUNTAS SOCIODEMOGRÁFICAS (PRIMERO) =====
        // (Aquí van las preguntas con area_id = 8, factor_id = 8, y order del 1 al 10)
        ...
        // ===== PREGUNTAS DE COMPETENCIAS DIGITALES (DESPUÉS) =====
        // (Aquí van el resto de preguntas, ajustando el order para que sigan después de las sociodemográficas)
